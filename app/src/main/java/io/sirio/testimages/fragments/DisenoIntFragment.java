 ...
 */
public class DisenoIntFragment extends Fragment {

    private CustomPagerAdapter mCustomPagerAdapter;
    private VerticalViewPager mViewPager;
    int[] mResources = {
            R.drawable.interior_0, R.drawable.interior_1, R.drawable.interior_2,
            R.drawable.interior_3, R.drawable.interior_4
    };
