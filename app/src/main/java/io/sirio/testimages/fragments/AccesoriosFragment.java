...
public class AccesoriosFragment extends Fragment {
    ...
    int[] mResources = {
            R.drawable.accesorios_0, R.drawable.accesorios_1, R.drawable.accesorios_2,
            R.drawable.accesorios_3, R.drawable.accesorios_4, R.drawable.accesorios_5,
            R.drawable.accesorios_6
    };
    ...
    private void setPager(int position){
        ...
        if(position == 6) imgDownPage.setVisibility(View.INVISIBLE);
