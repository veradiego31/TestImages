...
public class PerformanceFragment extends Fragment{
    ...
    int[] mResources = {
            R.drawable.performance_0, R.drawable.performance_1, R.drawable.performance_2,
            R.drawable.performance_3, R.drawable.performance_4
    };

    @BindView(R.id.imgDownPage) ImageView imgDownPage;
